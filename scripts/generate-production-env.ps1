...
PGSSL=require
PEGMA_ALLOWED_ORIGINS=https://tortelaplus-app.onrender.com,https://tortelaplus-rede.onrender.com
PEGMA_SECRET_KEY=$(Secret 48)
PEGMA_PUBLIC_LINK_SECRET=$(Secret 48)
PEGMA_CENTRAL_USER=admin
PEGMA_CENTRAL_PASSWORD=$(Secret 24)
PEGMA_PROVIDER_TOKEN=$(Secret 48)
PEGMA_BACKUP_DIR=COLE_AQUI_A_PASTA_OU_STORAGE_DE_BACKUP
