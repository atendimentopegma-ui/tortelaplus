...
function bindCurrentModule() {
  ...
  document.querySelectorAll("[data-new-person-type]").forEach((button) => {
    button.addEventListener("click", () => newPersonRecord(button.dataset.newPersonType || "Cliente"));
  });
